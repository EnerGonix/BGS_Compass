...
Config.MapTypeOnFoot = 1                -- Map type displayed on foot (default normal)
Config.MapTypeOnMount = 1               -- Map type displayed on horseback/vehicle (default normal)
Config.MapTypeCompassOnly = 3           -- Map type displayed if only compass is present
